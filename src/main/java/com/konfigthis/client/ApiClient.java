...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://127.0.0.1/v1";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("APIKeyAuthorizer", new ApiKeyAuth("header", "X-Api-Key"));
        authentications.put("JWTAuthorizer", new ApiKeyAuth("header", "Authorization: Bearer"));
        ...
        if (configuration != null) {
            if (configuration.aPIKeyAuthorizer != null) {
                this.setAPIKeyAuthorizer(configuration.aPIKeyAuthorizer);
            }
            if (configuration.jWTAuthorizer != null) {
                this.setJWTAuthorizer(configuration.jWTAuthorizer);
            }
            setVerifyingSsl(configuration.verifyingSsl);
        }
    }

    public String getAPIKeyAuthorizer() {
        return ((ApiKeyAuth) this.getAuthentication("APIKeyAuthorizer")).getApiKey();
    }

    public void setAPIKeyAuthorizer(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("APIKeyAuthorizer")).setApiKey(apiKey);
    }

    public void setAPIKeyAuthorizerPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("APIKeyAuthorizer")).setApiKeyPrefix(prefix);
    }
    public String getJWTAuthorizer() {
        return ((ApiKeyAuth) this.getAuthentication("JWTAuthorizer")).getApiKey();
    }

    public void setJWTAuthorizer(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("JWTAuthorizer")).setApiKey(apiKey);
    }

    public void setJWTAuthorizerPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("JWTAuthorizer")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://127.0.0.1/v1)

...
public class Event {
  ...
  private List<MetaInner> meta = new ArrayList<>();
  ...
  **/
  ...
  public Event meta(List<MetaInner> meta) {
  ...
  public Event addMetaItem(MetaInner metaItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "the Meta data of the Alert itself")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(timestamp, meta, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the required field `meta` (array)
